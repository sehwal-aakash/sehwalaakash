                ...
                <div className="container">
                    <div className="header-inner d-flex align-items-center">
                        ...
                        <div className="logo-outer">
                            <div className="logo">
                                <Link href="/">
                                    <Image width={120} height={40} sizes='100vw' src={"/images/sehwalaakash_logo.png"} alt="Logo" title="Logo" />
                                </Link>
                            </div>
                        </div>
                            ...
                            <nav className="main-menu navbar-expand-lg">
                                <div className="navbar-header">
                                    <div className="mobile-logo">
                                        <Link href="/">
                                            <Image width={75} height={25} sizes='100vw' src={"/images/sehwalaakash_logo.png"} alt="Logo" title="Logo" />
                                        </Link>
                                    </div>
                                    {/* <!-- Toggle Button --> */}
